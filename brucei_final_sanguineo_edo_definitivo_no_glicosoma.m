...
%     vpfk = (vmax_pfk*(((F6P/kpfk_f6p))^nhpfk)*ATPg)/(kpfk_atp*(1+(sqrt((F6P/kpfk_f6p)^2))^nhpfk)*(1+ATPg/kpfk_atp))*u4;
    ...
    vglyt=(vmax_glyt*GLY/kglyt-vmax_glyt/2.5*GLY_ext/kglyt)/(1+GLY/kglyt+GLY_ext/kglyt)*u21;
...
%d(Pg)/dt
    ...
    dpg=(-vhk-vpfk+vpgk+vgk+vpepck+2*vppdk-vatput2+vpyk-vatput-vpgkc)/vgly;
